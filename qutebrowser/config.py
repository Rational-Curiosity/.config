...
#  Type: Dict
c.aliases = {'w': 'session-save', 'q': 'close', 'qa': 'quit',
...
#    - webkit: Use QtWebKit (based on WebKit, similar to Safari - many
...
#     '<Ctrl-[>': '<Escape>', '<Ctrl-6>': '<Ctrl-^>', '<Ctrl-M>': '<Return>',
#     '<Ctrl-J>': '<Return>', '<Ctrl-I>': '<Tab>',
...
#    - minor: Show changelog for major and minor upgrades (e.g. v2.0.0 -> v2.1.0).  # noqa
#    - patch: Show changelog for major, minor and patch upgrades (e.g. v2.0.0 -> v2.0.1).  # noqa
...
c.content.user_stylesheets = ['~/.config/qutebrowser/css/hack.css']
...
#  Type: ShellCommand
c.editor.command = ['emacsclient', '+{line}:{column0}', '{file}']
...
c.hints.selectors = {
    'all': [
        ...
        'button', 'frame', 'iframe', 'svg', 'img', 'link', 'summary',
        'div.nav-item',
        '[contenteditable]:not([contenteditable="false"])',
        '[onclick]', '[onmousedown]', '[role="link"]', '[role="option"]',
        '[role="button"]', '[ng-click]', '[ngClick]', '[data-ng-click]',
        '[x-ng-click]', '[tabindex]', 'label'
    ],
    'links': [
        'a[href]', 'area[href]', 'link[href]', '[role="link"][href]'
    ],
    'images': ['img', 'svg'],
    'media': ['audio', 'img', 'svg', 'video'],
    'url': ['[src]', '[href]'],
    'inputs': [
    ...
    'scrollable': [
        'aside', 'section', 'article', 'main', 'summary', 'pre', 'nav',
        'div.data',
        '#content', '#side', '#sidebar', '#left-sidebar', '#right-sidebar',
        '.content', '.side', '.sidebar', '.left-sidebar', '.right-sidebar'
    ]
}
...
config.bind('<Ctrl-N>', 'scroll-page 0 0.15')
config.bind('<Ctrl-P>', 'scroll-page 0 -0.15')
...
config.bind('<Ctrl-X><2>', 'tab-clone')
config.bind('<Ctrl-X><3>', 'tab-clone')
config.bind('<Ctrl-X><5><0>', 'close')
config.bind('<Ctrl-X><5><1>', 'window-only')
config.bind('<Ctrl-X><5><2>', 'open -w')
config.bind(';s', 'hint scrollable')
config.bind('<Alt-O>', 'spawn easyfocus')
config.bind('<Ctrl-S>', 'set-cmd-text /')
config.bind('<Ctrl-R>', 'set-cmd-text ?')
config.bind('cm', 'clear-messages')
config.bind('ws', 'view-source')
config.bind('gf', 'hint --rapid')
config.bind('gF', 'hint --rapid all tab')
# quickmarks
config.bind('m', 'quickmark-save')
config.bind('gm', 'set-cmd-text -s :quickmark-load')
config.bind('M', 'set-cmd-text -s :quickmark-load -t')
config.bind('wm', 'set-cmd-text -s :quickmark-load -w')
...
config.bind('<Ctrl-Shift-Backspace>', 'fake-key <End><Shift-Home><Delete>', mode='insert')
